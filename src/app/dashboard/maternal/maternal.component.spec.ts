...
describe('MaternalComponent', () => {
  ...
  it('update_maternal_form method',()=>{
  ...
  it("success method ",()=>{
    ...
    component.success(response,"MaternalFormSubmit"); 
    component.success(response,"get_all"); 

  });
  it('petchUpdate method',()=>{
    component.petchUpdate(1,"key")
  })
});
