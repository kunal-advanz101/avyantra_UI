...
class MockReferralDoctorStaffComponent{
}


export const routes: Routes = [
  {
    path: 'admin', component: MockReferralDoctorStaffComponent,
    children: [
      {path:'staff',component:HospitalStaffComponent,canActivate: [AuthGuard]},
      {path: 'referral-doctor', component: MockReferralDoctorStaffComponent}
    ],
...
describe('ReferralDoctorStaffComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ ReferralDoctorStaffComponent,emptyDataPipe,MockReferralDoctorStaffComponent ,HospitalStaffComponent,statusPipe],
      imports: [
  ...
  it('openDetail method', () => {
    spyOn(component['modalService'], 'open');
    component.openDetail("openDetial",{});
...
it('onReferralSubmit method',()=>{
  component.onReferralSubmit();
});
it('switchTab method',()=>{
  component.switchTab('hospital-staf');
...
it("success method ",()=>{
  ...
  component.success(response,"addReferralDoctor"); 
  component.success(response,"getReferralDoctors"); 
  component.success(response,"getReferralDoctorRecordsCount"); 
  component.success(response,"getRegisteredReferralDoctorRecordsCount"); 
  component.success(response,"getRegisteredReferralDoctors"); 
  component.success(response,"statusUpdate"); 
