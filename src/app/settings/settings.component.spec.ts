...
describe('SettingsComponent', () => {
  ...
  it('onRoleFormSubmit method',()=>{
    component.onRoleFormSubmit();
  });
  it('removeBranchRole method',()=>{
    component.removeBranchRole(12);
  });
  it('onSpecialityFormSubmit method',()=>{
    component.onSpecialityFormSubmit();
  });
  // fit('setPermission method',()=>{
  //   let event={
  //     target:{checked:true}
  //   }
  //   component.userList = [
  ...
  //   component.setPermission(event,1,"test")
  // })
