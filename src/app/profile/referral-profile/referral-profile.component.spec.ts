...
describe('ReferralProfileComponent', () => {
  ...
  it('swapper method',()=>{
    ...
    var demo=component.swapper();
    expect(demo).toBe('text');
    component.is_toggle=false;
    var demo1=component.swapper();
    expect(demo1).toBe('password');
  });
  it("success method ",()=>{
    let response={
    ...
    component.success(response,"getReferralProfile"); 
    component.success(response,"updateReferralProfile"); 
