...
@NgModule({
  declarations: [AppComponent,
   ...
   UserInfoComponent,
    ...
    MyProfileComponent,passwordPipe,userTypePipe, HospitalStaffDashboardComponent, StaffProfileComponent, BranchAdminProfileComponent, ReferralProfileComponent, HospitalConnectComponent,emptyDataPipe,MessageCenterComponent,statusPipe, ScoreAnalysisComponent, RessetPasswordComponent,ScorePercentage, ButtonCursorDirective, AshaPhcDashboardComponent, HealthParametersComponent],
    imports: [
    BrowserModule,
    ReactiveFormsModule,
    AppRoutingModule,
