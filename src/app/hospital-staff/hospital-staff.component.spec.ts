...
describe('HospitalStaffComponent', () => {
  ...
  it("success method ",()=>{
    ...
    component.success(response,"addStaff"); 
    component.success(response,"getStaff"); 
    component.success(response,"getStaffCount"); 
    component.success(response,"updateStaff"); 
    component.success(response,"reportToStaffList"); 
